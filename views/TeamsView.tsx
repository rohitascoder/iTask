...
const TeamCard: React.FC<{ team: Team, leader?: User, members: User[] }> = ({ team, leader, members }) => (
    <div className="bg-white rounded-lg shadow border border-gray-200 p-6">
        ...
        <p className="text-sm text-gray-500 mb-4">
            Team Leader: <span className="font-medium text-primary-600">{leader?.username || 'Not assigned'}</span>
        </p>
        <div>
            <h4 className="font-semibold text-gray-700 mb-3">Members ({members.length})</h4>
